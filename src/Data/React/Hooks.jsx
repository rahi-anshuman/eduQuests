...
export  const hooks = [
    ...
    },
    {
     ...
     {
      "title": "useState",
      "description": "This is uses to intitialize the value, if the value is updated it will re-render the component. Use this when you want to change the ui/componet if the value of a variable changes. This returns two thine first is a value second is setter method for the value. If you want to update in varibale then use this setter method to update the value",
      "Synatx": `import { useState } from 'react' \n const [var,setVariable] = useState('inital_value)`
    } ,
    {
      "title": "useEffect",
    ...
    },
   {
        ...
        "code":"import React from 'react';\nexport function Header(props) {\nconsole.log('header rendered');\nreturn(\n<div >\n<h1>Header</h1>\n</div>);\n}\n//export default React.memo(Header); use React.memo in export in order to not rerender the component which in mounted in the component in which action is performed\nimport React,{ useState } from 'react';\nimport { Header } from './Header.jsx';\nexport function App(props) {\nconst [count,setCount]=useState(0);\nreturn (\n<div className='App'>\n<Header/>\n<h1>{count}</h1>\n<button onClick={()=>{setCount(count+1)}}>Start editing to see some magic happen!</button>\n</div>\n);\n}\nsecond example \n import React,{ useState, useCallback } from 'react';\n import { Header } from './Header.jsx';\nexport function App(props) {\nconst [count,setCount] = useState(0);\n const newFn = useCallback(()=>{},[])\nreturn(\n<div>\n<Header newFn={newFn}/>\n<h1>{count}</h1>\n<button onClick={()=>{setCount(count+1)}}>Start editing to see some magic happen!</button>\n</div>\n);\n}"
    }    
  ]
